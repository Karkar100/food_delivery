...
class CityDropDown: UIView {
    ...
    */
    var makeDropDownIdentifier: String = "DROP_DOWN"
        ...
        var makeDropDownDataSourceProtocol: DropDownDataSourceProtocol?
        var nib: UINib?{
            didSet{
                dropDownTableView?.register(UITableViewCell.self, forCellReuseIdentifier: self.cellReusableIdentifier)
            }
        }
        // Other Variables
...
extension CityDropDown: UITableViewDataSource, UITableViewDelegate{
